...
export default class addEditCond extends Component {
    ...
    componentDidMount() {
        if (this.props.condition !== null) {
            this.setState({
                condName: this.props.condition.cond_name,
                condDesc: this.props.condition.cond_desc,
                isEdit: true,
            })
        }
    }
    ...
    handleOnSubmit = e => {
        e.preventDefault();
        const condition = {
            cond_name: this.state.condName,
            cond_desc: this.state.condDesc
        };

        if (!this.state.isEdit) {
            console.log(condition)
            create(condition).then(response => {
            ...
            console.log(condition)
            updateCond(condition).then(response => {
                console.log(response);
            }).catch(function (error) {
                console.log(error);
            });;
    ...
    render() {
        const { condName, condDesc } = this.state;
