	...
	render() {
		return (
			<>
				...
				<div class="min-h-screen flex items-center px-purple-500">
					<div class="flex-1  mx-auto p-10">
						<div class="grid grid-cols-6 grid-flow-col ">
							<ul class=" col-span-1">
								...
								<li class="my-px">
									<span class="flex font-medium text-sm text-gray-400 px-4 my-4 uppercase">Category</span>
								</li>
								<li class="my-px">
									<a href="#"
										...
										<span class="ml-3">Handphone & Component</span>
									</a>
								</li>
								<li class="my-px">
									<a href="#"
								...
								<li class="my-px">
									<a href="#"
										...
										<span class="ml-3">Pakaian Pria</span>
								...
								<li class="my-px">
									<a href="#"
										...
										<span class="ml-3">Pakaian Dewasa</span>
									</a>
								</li>
								<li class="my-px">
									<span class="flex font-medium text-sm text-gray-400 px-4 my-4 uppercase">Brand</span>
								</li>
								<li class="my-px">
									<a href="#"
										class="flex flex-row items-center h-12 px-4 rounded-lg text-gray-600 hover:bg-gray-100">
								...
								<li class="my-px">
									<a href="#"
										...
										<span class="ml-3">Eiger</span>
									</a>
								</li>
								<li class="my-px">
									<span class="flex font-medium text-sm text-gray-400 px-4 my-4 uppercase">Condition</span>
								</li>
								<li class="my-px">
									<a href="#"
										class="flex flex-row items-center h-12 px-4 rounded-lg text-gray-600 hover:bg-gray-100">
									...
									<div class=" bg-gray-100 flex justify-center">
										<div class="bg-white w-80 shadow-lg cursor-pointer rounded transform hover:scale-105 duration-300 ease-in-out">
											...
											<div class="p-4">
												...
												<p class="font-light text-gray-500 text-lg my-2">29,99 &euro;</p>
												<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt</p>
												<a href="#" class="block bg-gray-300 py-2 px-2 text-gray-600 text-center rounded shadow-lg uppercase font-light mt-6 hover:bg-gray-400 hover:text-white duration-300 ease-in-out">Add to cart</a>git 
											</div>
										</div>
									</div>
								</div>
