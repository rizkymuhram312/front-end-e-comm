...
export default function TotalProdSK() {

    const [OrderSK, SetOrderSk ] = useState([]);
    
    const GetOrderSK = async () => {
        const response = await axios.get(`${apiUserAccount}/dashboard/ProdCST`);
                ...
                <div className="rounded-t mb-0 px-4 py-3 border-0">
                    <div className="flex flex-wrap items-center">
                        <div className="relative w-full px-4 max-w-full flex-grow flex-1">
                            <h3 className="font-semibold text-base text-gray-800">All Product Order by Seller</h3>
                        </div>
                    ...
                    <table className="items-center w-full bg-transparent border-collapse">
                        ...
                        <tbody >
                          ...
                          <td class="w-full lg:w-auto p-3 text-gray-800 text-center border border-b text-center block lg:table-cell relative lg:static">
                            <span class="lg:hidden absolute top-0 left-0 bg-blue-200 px-2 py-1 text-xs font-bold uppercase">Total Product</span>
