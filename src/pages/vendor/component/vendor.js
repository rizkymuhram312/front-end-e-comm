                            ...
                            <div className="relative w-5/12 my-6 mx-auto">
                                ...
                                <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                                    ...
                                    <div className="relative p-6 flex-auto">
                                        ...
                                        <div class="mb-3 pt-0">
                                            <input disabled type="text" name="vendorName" value={props.name} class="px-3 py-3 placeholder-gray-400 text-gray-700 relative bg-gray-100 rounded text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full" />
                                        </div>
                                        <h1 className="font-semibold text-base text-gray-800 float-left">Vendor Description</h1>
                                        <div class="mb-3 pt-0">
                                            <input type="text" name="vendorDesc" class="px-3 py-3 placeholder-gray-400 text-gray-700 relative bg-white bg-white rounded text-sm shadow outline-none focus:outline-none focus:shadow-outline w-full" />
                                        </div>
                                    </div>
                                    {/*footer*/}
