        ...
        <div>
            <div className="mx-12">
                ...
                <div className=" flex-wrap">
                    ...
                    {
                        error && (
                            <div className="bg-red-100 border-l-4 content-center items-center text-center border-blue-500 col-span-2 text-red-700 p-4" role="alert">
                                <p>{error}</p>
                            </div>
                        )
                    }   
                    {
                        alert && (
                            <div className="bg-blue-100 border-l-4 content-center items-center text-center border-blue-500 col-span-2 text-blue-700 p-4" role="alert">
                                <p>{alert}</p>
                            </div>
                        )
                    }   
                        <h1 hidden className="justify-self-end">Email : </h1>
