...
import IndexCategory from '../../pages/category/category'
    ...
    <div className="flex flex-wrap">
      <div className="md:w-2/12 flex flex-row  md:flex-col">
        <div className="w-full md:mt-10 px-1 font-bold text-md flex flex-row  md:flex-col ">
          ...
          <div className="py-5 px-2 text-white bg-primary" style={{ cursor: 'pointer' }} onClick={() => history.push("/category")}>Category</div>
